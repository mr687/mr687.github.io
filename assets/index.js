const goto = (name) => {
  ...
  const links = {
    ...
    resume: {
      type: "external",
      url: "https://github.com/mr687/mr687.github.io/raw/master/assets/doc/Resume-Davi%20Nomoeh%20Dani.pdf",
    },
    vooka: { type: "external", url: "https://vookav2.github.io" },
    supirbarang: { type: "external", url: "https://supirbarang.com" },
    "github-vooka": { type: "external", url: "https://github.com/vookav2" },
    codewars: { type: "external", url: "https://www.codewars.com/users/mr687" },
    npm: { type: "external", url: "https://www.npmjs.com/~mr687" },
    youtube: {
      type: "external",
      url: "https://www.youtube.com/channel/UCZoJY-3dj0ZybKE353Hbnlw",
    },
    linkedin: { type: "external", url: "https://www.linkedin.com/in/daphino/" },
    "github-mr687": { type: "external", url: "https://github.com/mr687" },
    "github-web": {
      type: "external",
      url: "https://github.com/mr687/mr687.github.io",
    },
    "github-vooka": {
      type: "external",
      url: "https://github.com/vookav2/vooka",
    },
    "github-songlyrics": {
      type: "external",
    ...
    "npm-songlyrics": {
      type: "external",
      url: "https://www.npmjs.com/package/songlyrics",
    },
    "npm-searchmusic": {
      type: "external",
      url: "https://www.npmjs.com/package/@vookav2/searchmusic",
    },
    "github-searchmusic": {
      type: "external",
      url: "https://github.com/vookav2/searchmusic",
    },
    "github-shortener": {
      type: "external",
      url: "https://github.com/mr687/URLs-Shortener",
    },
    "github-voohook": {
      type: "external",
      url: "https://github.com/mr687/voohook",
    },
    voohook: { type: "external", url: "http://voohook.herokuapp.com/" },
    "npm-idcloudhost": {
      type: "external",
      url: "https://www.npmjs.com/package/idcloudhost-node-client",
    },
    "github-idcloudhost": {
      type: "external",
    ...
    "npm-geoip": {
      type: "external",
      url: "https://www.npmjs.com/package/@mr687/reqeust-info",
    },
    "github-geoip": {
      type: "external",
